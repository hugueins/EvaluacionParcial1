...
CREATE TABLE IF NOT EXISTS `peliculas`.`usuario` (
  ...
  INDEX `fk_usuario_rol1_idx` (`rol_rol_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `peliculas`.`peliculas` (
  ...
  INDEX `fk_peliculas_usuario1_idx` (`usuario_beneficiario_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `peliculas`.`calificacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `peliculas`.`calificacion` (
  ...
  INDEX `fk_valoracion_usuario1_idx` (`usuario_beneficiario_id` ASC) VISIBLE,
  INDEX `fk_calificacion_valoracion1_idx` (`valoracion_valoracion_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `peliculas`.`actores_has_peliculas` (
  ...
  INDEX `fk_actores_has_peliculas_peliculas1_idx` (`peliculas_peliculas_id` ASC) VISIBLE,
  INDEX `fk_actores_has_peliculas_actores1_idx` (`actores_actor_id` ASC) VISIBLE,
